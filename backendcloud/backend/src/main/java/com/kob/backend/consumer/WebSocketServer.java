...
public class WebSocketServer {
  ...
  private final static String ADD_PLAYER_URL = "http://127.0.0.1:3031/player/add/";
  private final static String REMOVE_PLAYER_URL = "http://127.0.0.1:3031/player/remove/";
